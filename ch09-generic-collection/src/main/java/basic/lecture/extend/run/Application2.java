...
public class Application2 {
    public static void main(String[] args) {
         ...
         * <?> : 제한 없음
         * <? extends Type> :  와일드 카드의 상한 제한 (Type과 Tpye의 후손을 이용해 생성한 인스턴스만 사용가능)
         * <? super Type> :  와일드 카드의 하한 제한 (Type과 Tpye의 부모를 이용해 생성한 인스턴스만 사용가능)
         * */

        WildCardFarm wildCardFarm = new WildCardFarm();

        // 와일드카드의 매개변수 타입 제한이 없는 경우
        //  토끼 농장 자체가 생성 불가능한것은 매개변수로 사용 불가능
//        wildCardFarm.anyType(new RabbitFarm<Mammal>(new Mammal()));
        ...
        // Bunny 이거나 Bunny의 후손만 사용 가능 (Rabbit은 Bunny의 상위라 불가)
