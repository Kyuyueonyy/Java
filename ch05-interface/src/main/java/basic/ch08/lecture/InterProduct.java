...
public interface InterProduct {
    ...
    * */
    ...
    //public static final이 앞에 숨어있음! 컴파일러가 자동으로 ..
    int MIN_NUM = 10;
    int MAX_NUM = 100;
    ...
    //인터페이스는 구현부가 있는 메서드를 가질 수없음
    //public void nonStaticMethod() {}

    //인터페이스는 static메서드는 가질 수 있음(java 8버전 이후)
    ...
    * 인터페이스를 상속받은 클래스는 메소드를 구현할때 꼭 접근제어자를 public 으로 해야 구현 가능함*/
    void abstMethod();

    //인터페이스는 일반 메소드를 만들기 위해서는 dafault 키워드를 붙여야한다.
